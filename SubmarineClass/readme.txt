<Your Name> <The Prac> Readme

Date created: <Date this ReadMe is written>

Date last modified: <Date this ReadMe is last changed.>

Purpose: <What is the purpose of the program.>

Files in project: <List of the name of the files that makes up the program.>

Test Files: <Name of the test files that you have prepared as well as what part of the program is the test file testing. Could also include any other files related to testing (e.g. test results)>

Functionality: <What does your program do. Necessary features that is specified in the scope.>

TODO: <What necessary functionality is yet to be completed> 
